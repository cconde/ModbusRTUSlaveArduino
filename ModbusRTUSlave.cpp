        ...
        switch(Function)
        {
          ...
          case 2:
            if(ResCnt >= 8)
            {
              ...
              {
                bvalid = false;
                //Illegal Data Address Modbus error message
                byte ret[5];
                ret[0]=Slave; 
                ret[1]=Function & 0x80;  
                ret[2]=0x02;  //Illegal Data Address
                byte hi = 0xFF, lo = 0xFF;
                getCRC(ret, 5, 0, 3, &hi, &lo);
                ret[3]=hi;
                ret[4]=lo;
                this->doWrite(ret, 6);
                ResCnt=0;  //Inherited.
          ...
          case 16:  //MultiWordWrite
            ...
            break;
          //Illegal Function Modbus error message
          default:
            byte ret[5];
            ret[0]=Slave; 
            ret[1]=Function + 0x80;  
            ret[2]=0x01;  //Illegal Function
            byte hi = 0xFF, lo = 0xFF;
            getCRC(ret, 5, 0, 3, &hi, &lo);
            ret[3]=hi;
            ret[4]=lo;
